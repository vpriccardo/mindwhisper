/**
 * AudioWorkletProcessor: 16 narrow band-pass filters → 8 pair ratio features / ~20ms.
 * Does NOT send raw PCM to the main thread.
 */
...
class RxWatermarkProcessor extends AudioWorkletProcessor {
  constructor() {
    super();
...
registerProcessor('rx-watermark-processor', RxWatermarkProcessor);
